        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => ServiceDirectoryWidget(
                categoryfilterB:
                    params.getParam('categoryfilterB', ParamType.String),
                categoryFilterC:
                    params.getParam('categoryFilterC', ParamType.String),
                categoryFilterT:
                    params.getParam('categoryFilterT', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'chatFlow',
              path: 'chatFlow',
              builder: (context, params) => ChatFlowWidget(),
            ),
            FFRoute(
              name: 'institutionDetails',
              path: 'institutionDetails',
              builder: (context, params) => InstitutionDetailsWidget(
            ...
            FFRoute(
              name: 'newsDetailed',
              path: 'newsDetailed',
              builder: (context, params) => NewsDetailedWidget(
                newstitle: params.getParam('newstitle', ParamType.String),
